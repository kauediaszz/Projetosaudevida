...
<body class="main" id="topo">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
                <!-- Menu suspenso de Especialidades -->
            <div class="dropdown">
            ...
            <li class="nav-item"><a class="nav-link" href="pag-consultas_agendadas.php">Suas Consultas</a></li>
  ...
  <div id="mensagem-boas-vindas" class="alert alert-success alert-dismissible fade show" role="alert" style="display: none;">
  ...
  <!-- Âncoras invisíveis (não geram barras) -->
